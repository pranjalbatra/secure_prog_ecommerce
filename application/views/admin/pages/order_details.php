                    ...
                    <tbody>
                        ...
                        foreach ($order_details_info as $single_order_details) {
                            ...
                            <tr>
                                ...
                                <td>AUD.<?php echo $this->cart->format_number($single_order_details->commodity_price)?> </td>
                                <td><?php echo $single_order_details->commodity_sales_quantity ?></td>
                                <td>AUD.<?php echo $this->cart->format_number($single_order_details->commodity_price * $single_order_details->commodity_sales_quantity) ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                    <tfooter>
                        <td colspan="5">Total Amount</td>
                        <td>= AUD.<?php echo $this->cart->format_number($order_info->order_total)?> </td>
                    </tfooter>
                </table>            
            </div>
        </div><!--/span-->
