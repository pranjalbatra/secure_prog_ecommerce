...
<body>
  ...
  <div class="box2">
    ...
    <div class="box3">
      <h2>About Us</h2>
      <p5>Funity was founded in 1991 with the sole purpose of manufacturing high-quality wooden toys. After being recognized by the public as a quality brand, Funity expanded their market into board games and board game accessories. Funity immediately found success in this market and has been the top board game manufacturer ever since.</p5>
      <br><br><p5>To celebrate the launch of the Funity website, use the following coupon code to receive 20% off any online purchase:</p5><br>
      <br><h1>2020RELEASE</h1><br>
      <p5>Thank you for your continued support.</p5>
    </div>
  </div>
